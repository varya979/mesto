...
export const profilePopupInputName = profilePopup.querySelector(
  ".popup__input_type_name"
);
export const profilePopupInputDescription = profilePopup.querySelector(
...
export const cardPopupInputImg = cardPopup.querySelector(
  ".popup__input_type_description"
);

export const avatarPopup = document.querySelector(".popup_type_update-avatar");
export const avatarPopupOpenBtn = document.querySelector(
